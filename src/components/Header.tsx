  ...
  return (
    ...
    >
      <div className='container mx-auto flex justify-between items-center'>
        ...
        {/* instagram button - initially hidden - show on desktop mode */}
        <button
        ...
        <button className='lg:hidden' onClick={() => setMobileNav(!mobileNav)}>
          {mobileNav ? (
            <HiOutlineX className='text-3xl text-darkGreenCustom' />
          ) : (
            <HiMenuAlt4 className='text-3xl text-darkGreenCustom' />
          )}
        </button>
